...
lrt_p_values <- vector(mode = "numeric", length = nrow(snoqualmie_matrix))
for (i in 1:nrow(snoqualmie_matrix)) {
  snoqualmie_year <- snoqualmie_matrix[i, ]
  snoqualmie_year_test <- single_binary_test(snoqualmie_year, swaps = 10000, n = 10000)
  lrt_p_values[i] <- snoqualmie_year_test$p_value_lrt
}
...
snoqualmie_test <- multiple_binary_test(binary_chains = snoqualmie_matrix, swaps = 10000, n = 10000)
